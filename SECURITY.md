...
If you discover a security vulnerability in RAWK, please report it responsibly:
...
RAWK supports the `system()` function and pipe operations, which execute shell commands. Users should be aware that:
...
4. **Limit permissions** when running rawk on sensitive systems
...
Thank you for helping keep RAWK secure!
